...
<head>
    ...
    <title>Administrateur- Quizzeo</title>
...
<div style=" justify-content: center; align-items: center; display: flex;" class="row">
    <div class="col-1 col-lg-4">
        ...
        <a style="font-size: 40px;" href="createquiz.php"> Create a quiz.</a> <br>
        
    </div>
    <div class="col-2 col-lg-4">
    <a style="font-size: 40px;" href="">Answer a quiz</a> 
    </div>
    <div class="col-2 col-lg-4">
    <a style="font-size: 40px;" href=""> Consult users</a> 
    </div>
